...
export const settingsRoutes: RouteDefinition[] = [
  ...
  },
  {
    ...
    path: '/faqs',
    handler: listFaqs,
    summary: 'List published FAQs, in display order',
    description: 'Public. An unpublished FAQ is simply omitted, same convention as an unset policy page.',
    responses: {
      200: { description: 'Published FAQs.', schema: faqsListResponseSchema },
    },
  },
  {
    method: 'get',
    path: '/faqs/admin',
    handler: [...staffOnly, listFaqsAdmin],
    summary: 'List every FAQ, including unpublished drafts (SUPER_ADMIN/ADMIN only)',
    responses: {
      200: { description: 'All FAQs.', schema: faqsListResponseSchema },
      401: { description: 'Missing or invalid bearer token.', schema: apiErrorResponseSchema },
      403: { description: 'Not SUPER_ADMIN or ADMIN.', schema: apiErrorResponseSchema },
    },
  },
  {
    method: 'post',
    path: '/faqs',
    handler: [...staffOnly, validateBody(createFaqSchema), createFaq],
    summary: 'Create an FAQ',
    request: { body: createFaqSchema },
    responses: {
      201: { description: 'FAQ created.', schema: faqResponseSchema },
      401: { description: 'Missing or invalid bearer token.', schema: apiErrorResponseSchema },
      403: { description: 'Not SUPER_ADMIN or ADMIN.', schema: apiErrorResponseSchema },
      422: { description: 'Validation failed.', schema: apiErrorResponseSchema },
    },
  },
  {
    method: 'put',
    path: '/faqs/:id',
    handler: [...staffOnly, validateBody(updateFaqSchema), updateFaq],
    summary: 'Update an FAQ',
    request: { body: updateFaqSchema },
    responses: {
      200: { description: 'FAQ updated.', schema: faqResponseSchema },
      400: { description: 'id was not a positive integer.', schema: apiErrorResponseSchema },
      401: { description: 'Missing or invalid bearer token.', schema: apiErrorResponseSchema },
      403: { description: 'Not SUPER_ADMIN or ADMIN.', schema: apiErrorResponseSchema },
      404: { description: 'No FAQ with that id.', schema: apiErrorResponseSchema },
      422: { description: 'Validation failed.', schema: apiErrorResponseSchema },
    },
  },
  {
    method: 'delete',
    path: '/faqs/:id',
    handler: [...staffOnly, deleteFaq],
    summary: 'Delete an FAQ',
    responses: {
      200: { description: 'FAQ deleted.', schema: deleteFaqResponseSchema },
      400: { description: 'id was not a positive integer.', schema: apiErrorResponseSchema },
      401: { description: 'Missing or invalid bearer token.', schema: apiErrorResponseSchema },
      403: { description: 'Not SUPER_ADMIN or ADMIN.', schema: apiErrorResponseSchema },
      404: { description: 'No FAQ with that id.', schema: apiErrorResponseSchema },
